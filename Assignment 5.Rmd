...
```{r}
'rules' for advice using this tree: 
 -if student asks for 0 hints, no intervention 
-if student asks for more than one hint monitor 
 given these  rules, the teacher needs to pay attention to prior percent correct and number of hints asked for
```
