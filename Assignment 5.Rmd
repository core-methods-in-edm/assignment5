...
```{r}
D1$advice <- ifelse(D1$score <=0.5, "intervene", ifelse(D1$score > 0.5 & D1$score <=0.8, "monitor", "no action"))
```
...
tab <-table(D2$advice, D2$prediction)
