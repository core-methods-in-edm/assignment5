...
#Teacher should pay most closely attention to students who require more than 12 hints, and less than 12 hints but score lower than 0.629. 
...
D2$match <- ifelse(D2$prediction == D2$actual, 1, 0)
#Number of prediction which matches the actual results
sum(D2$match)
#accuracy is:
accuracy = sum(D2$match) / 200
accuracy
```
