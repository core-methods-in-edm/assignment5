...
It's not very accurate. All of the scores are 1, so all predictions should be no action. However,it is only 58% correct. 

```{r}
#create same categories of advice as D1
