...
```{r}
D1$advice <- ifelse(D1$score <=0.4, "intervene", 
                    ifelse(D1$score>0.4&D1$score<=0.8, "monitor", 
                           "no action")) 
```
...
The teacher should most closely pay attention to monitor.
#Test Tree
