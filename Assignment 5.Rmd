...
## Part I
```{r}
D1 <- read.csv("D:/Github/4050/assignment5-master/intelligent_tutor.csv")
```
...
#I think teahcer should pay most attension to Node8 and Node 3. Teachers should pay more attension on these kids who get middle grade. These kids are not doing so well as kids in Node4, and not get attension as kid in Node4.
