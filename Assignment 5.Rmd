...
plot(score_ctree)
```
![Decision Tree](http://127.0.0.1:24412/chunk_output/2015B7F4FAFE7044/DB1292A0/cucxp88snzm10/000003.png)
...
#To be honest, I'm not sure if I am interpreting this right but with the following code - I think the difference between observed and predicted results is 58%.
