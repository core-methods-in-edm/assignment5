...
#Plot tree
```{r}
plot(score_ctree, file = "plottree.ps", title = "1-Score Less Than 1/3 2-Score Less Than 2/3  3-Score Less Than 1")
```                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    

Please interpret the tree, which two behaviors do you think the teacher should most closely pay attemtion to?
If the hints p = 0.039 and >12, teacher should monitor student progress.
