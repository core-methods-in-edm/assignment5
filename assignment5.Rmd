...
#Yes. From the variance plot, we want to drop PC6 because PC6 only accounts for 8.931% of variance in the data. However, if we dropped PC6 in the previous step, we might lose an important components for mean_correct. PC6 has a correlation of -0.4 with mean_correct
```
...
#PC1 has higher loading scores for mean_hint and mean attempt, which means it can be viewed as a measure of students' efforts put in the current session. PC2 has higher loading scores for prior_prob_count and prior_percent_correct, which means it can be viewed as a measure of students' efforts put in the prior session. PC3 has a higher score for mean_confidence, which means PC3 can be viewed as a measure of students' confidence of their ability.
```
# Part III  
...
# In this PCA, PC1 has higher loading scores for Adult.Education, Arts.Administration and Bilingual.Bicultural.Education. This indicates it can be viewed as a measure of Education-related programs. 
# PC2 has higher loading scores for Physiology, Behavior.Analysis, and Clinical.Psychology. This indicates it can be viewed as a measure of Medicine and Psychology-related programs. 
# PC3 has higher loading scores for Arts.Administration and Cognitive.Science. This indicates it can be viewed as a measure of Art and cognitive science-related programs. 
# PC4 has higher loading scores for Anthropology, Linguistics,Teaching.English, Bilingual.Bicultural.Education and Communication.Sciences.and.Disorders. This indicates it can be viewed as a measure of Linguistics-related programs.
biplot(pca2)
```
