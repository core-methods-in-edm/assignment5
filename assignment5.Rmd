...
#PC1 might represent prior knowledge and confidence with the question. PC2 may be how much the students have been previously tested. PC3 may have to do with current testing, maybe the attempts. PC4 could be the relationship between correctness and number of hints asked. PC5 could be the students' engagement in solving problems. PC6 could be correctness of problems and hints asked prior.  
...
#The biplot is  hard to see... I wasn't able to figure out how to make it clearer
```
```
