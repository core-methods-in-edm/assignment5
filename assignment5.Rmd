...
I will drop component 7 because it accounts for least amount of variance. 
...
ggpairs(D3, 2:7, progress = FALSE)

# No, the correlation plots between the transformed data and mean_correct did not change a lot. The dropped component 7 is not too important and it can be removed.
```
...
```
There are 50 components. Here are two major componets that I found that might have high correlation: PC1: Physiology, Behavior Analysis, Clinical Psychology, Nursing, Health.Education, Kinesiology, Neuroscience, Psychology; PC2: Arts.Administration, Cooperation.and.Conflict.Resolution, Economics.and.Education, Education.Policy, Change.Leadership, Leadership, Politics, Private.School.Leadership. I looked at the loadings which show how much amount of this question belongs in this component, and the questions under the same componet have similar loading values. It does make sense because PC1 is medical and physical condition related while PC2 is business and administraed related. Thus, I think there are relationship between these programs. 
