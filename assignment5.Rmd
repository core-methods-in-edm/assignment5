...
```{r}
#I will drop PC1 because its standard deviation is 1.45, which is much higher compared to the rest. It's variance is also too high (greater than 2) compared to the rest. A higher standard deviation and variance mean the data is widely spread and less reliable. 
...
#The graphs indicate that there are relationships between programs. The programs that are related generally would share similar foundational courses or have the same words used in the title of the program. 
