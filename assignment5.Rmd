...
I decide to drop PC6 because it accounts for the least proportion of variance. 
## Part II
...
#Now re-run your correlation plots between the transformed data and mean_correct. If you had dropped some components would you have lost important information about mean_correct?If I had dropped PC6, I would have lost important information becase the correlation between PC6 and mean_correct is -0.393, which is not small. 
...
#Students who attempted more asked for more hints, had less number of prior percent of correct questions, had less confidence.  
...
```{r}
A1<- read.csv("tc-program-combos.csv", header = TRUE)

row.names(A1) <- A1$program

A2<- subset(A1,select = -1)
...
##From the biplot, all psychology courses such as clinical psychology, counseling psychology, developmental psychology,psychology...are releated (they point to the same direction); adult education, arts administration, bilingul bicultural education are realted; Behavioral analysis, physiology are related with other psychology courses. 
