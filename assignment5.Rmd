...
# Yes, if I had dropped PC5, PC6, and PC7, I would not notice the strong relationship between mean_correct and PC6
```
...
# Based on the biplot, we can see that mean_correct, mean_hint, mean_attempt, and problem_attempted point in the same direction.
```
# Part III  
